...
import { glassClassName, glassStyles } from "./styles"
...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none",
  {
    variants: {
      variant: {
        default: cn(glassClassName, glassStyles.hover, glassStyles.active),
        destructive:
          "bg-red-500/50 text-white hover:bg-red-500/70 backdrop-blur-md border border-white/20",
        outline: cn(
          "border",
          glassStyles.border,
          glassStyles.text,
