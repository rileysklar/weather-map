  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-stone-900/80 backdrop-blur-sm animate-fade-in z-50">
      <div className="flex flex-col items-center animate-fade-in rounded-[1rem] overflow-hidden">
        ...
        <span className="animate-fade-in bg-black/25 backdrop-blur-md border border-white/20 text-white bg-emerald-500 px-4 py-2 rounded-lg font-black-ops-one text-xl transition-transform duration-200">
          🛡️MapShield
        </span>
      </div>
    </div>
